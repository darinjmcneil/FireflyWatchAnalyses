...
cdl_2015 <- raster("E:\\FireflyAnalysis_October2020\\CDL_rasters\\2015_30m_cdls\\2015_30m_cdls.img")
crs(cdl_2015)
...
plot(cdl_2015, main="CDL 2015") # this mapped super fast 
...
pseudostates1 <- sf::st_transform(pseudostates1, crs = crs(cdl_2015))
...
for(PseudostateName in FocalStateNames1){
  ...
  PathToFolder <- ("E:\\FireflyAnalysis_October2020\\CDL_individual_pseudostates\\2015\\") # this needs to be tweaked for each year
