...
pseudostates1 <- st_read("E:\\FireflyAnalysis_October2020\\analysis code\\FireflyWatchAnalyses\\pseudostates\\US_PseudostateBoundaries1.shp")
...
pseudostates1 <- sf::st_transform(pseudostates1, crs = crs(cdl_2008))
...
for(PseudostateName in FocalStateNames1){
  ...
  PathToFolder <- ("E:\\FireflyAnalysis_October2020\\CDL_individual_pseudostates\\2008\\") # this needs to be tweaked for each year
