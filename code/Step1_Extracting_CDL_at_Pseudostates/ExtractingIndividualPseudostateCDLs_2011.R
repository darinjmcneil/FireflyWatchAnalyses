...
cdl_2011 <- raster("E:\\FireflyAnalysis_October2020\\CDL_rasters\\2011_30m_cdls\\2011_30m_cdls.img")
crs(cdl_2011)
...
plot(cdl_2011, main="CDL 2011") # this mapped super fast 
...
pseudostates1 <- sf::st_transform(pseudostates1, crs = crs(cdl_2011))
...
for(PseudostateName in FocalStateNames1){
  ...
  PathToFolder <- ("E:\\FireflyAnalysis_October2020\\CDL_individual_pseudostates\\2011\\") # this needs to be tweaked for each year
