...
cdl_2016 <- raster("E:\\FireflyAnalysis_October2020\\CDL_rasters\\2016_30m_cdls\\2016_30m_cdls.img")
crs(cdl_2016)
...
plot(cdl_2016, main="CDL 2016") # this mapped super fast 
...
pseudostates1 <- sf::st_transform(pseudostates1, crs = crs(cdl_2016))
...
for(PseudostateName in FocalStateNames1){
  ...
  PathToFolder <- ("E:\\FireflyAnalysis_October2020\\CDL_individual_pseudostates\\2016\\") # this needs to be tweaked for each year
