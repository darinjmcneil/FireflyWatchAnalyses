...
cdl_2013 <- raster("E:\\FireflyAnalysis_October2020\\CDL_rasters\\2013_30m_cdls\\2013_30m_cdls.img")
crs(cdl_2013)
...
plot(cdl_2013, main="CDL 2013") # this mapped super fast 
...
pseudostates1 <- sf::st_transform(pseudostates1, crs = crs(cdl_2013))
...
for(PseudostateName in FocalStateNames1){
  ...
  PathToFolder <- ("E:\\FireflyAnalysis_October2020\\CDL_individual_pseudostates\\2013\\") # this needs to be tweaked for each year
