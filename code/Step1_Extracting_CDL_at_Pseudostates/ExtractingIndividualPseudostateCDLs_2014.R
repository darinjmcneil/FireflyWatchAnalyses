...
cdl_2014 <- raster("E:\\FireflyAnalysis_October2020\\CDL_rasters\\2014_30m_cdls\\2014_30m_cdls.img")
crs(cdl_2014)
...
plot(cdl_2014, main="CDL 2014") # this mapped super fast 
...
pseudostates1 <- sf::st_transform(pseudostates1, crs = crs(cdl_2014))
...
for(PseudostateName in FocalStateNames1){
  ...
  PathToFolder <- ("E:\\FireflyAnalysis_October2020\\CDL_individual_pseudostates\\2014\\") # this needs to be tweaked for each year
