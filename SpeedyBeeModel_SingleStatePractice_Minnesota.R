...
# subset reclass table for Minnesota
MN2008_reclasstable <- subset(ReclassTable1, state_alpha == "MN" & year == "2008") # subset table for focal state/year

# export the subsetted reclass table
write.csv(MN2008_reclasstable, paste0(ReclassTableDir1, "\\MN2008.csv"))

# define path to CDL raster file
MN_cdl2008path <- "E:\\FireflyAnalysis_October2020\\CDL_individual\\2008\\CDL_2008_Minnesota.tif"
plot(raster(MN_cdl2008path))
